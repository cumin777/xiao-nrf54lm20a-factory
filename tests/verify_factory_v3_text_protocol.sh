...
rg -n "text_handle_sleep_mode|text_handle_ship_mode|at_prepare_sleepi" src/at_handler.c >/dev/null
...
rg -n "sleep mode 作为 V3 正式文本命令|AT\\+SLEEPI" docs/AT_USAGE.md >/dev/null
